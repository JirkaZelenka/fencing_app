...
urlpatterns = [
    ...
    path('photos/find-person/', views.find_person_photos, name='find_person_photos'),
    path('photos/photo/<int:photo_id>/tags/', views.update_photo_tags, name='update_photo_tags'),
